...
import 'package:flutter_math_keyboard_demo/keyboard/widgets/view_insets.dart';
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: _Buttons(
                                controller: controller,
                                page1: type != MathKeyboardType.custom
                                    ? (type == MathKeyboardType.numberOnly
                                        ? numberKeyboard
                                        : standardKeyboard)
                                    : customKeyboard,
                                page2: type != MathKeyboardType.custom
                                    ? (type == MathKeyboardType.numberOnly
                                        ? null
                                        : functionKeyboard)
                                    : lowerCaseLatterKeyboard as List<List<KeyboardButtonConfig>>,
                                onSubmit: onSubmit,
                              ),
                            ),
                          ],
