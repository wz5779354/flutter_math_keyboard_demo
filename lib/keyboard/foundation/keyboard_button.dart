...
const _equalButton = BasicKeyboardButtonConfig(
  label: '=',
  value: '=',
  keyboardCharacters: ['='],
  highlighted: true,
);
const _paiButton = BasicKeyboardButtonConfig(
  label: '=',
  value: '=',
  keyboardCharacters: ['='],
  highlighted: true,
...
var lowerCaseCharCodes = [];
var charCodes = [];

getChat() {
  for (var i = 65; i < 97; i++) {
    charCodes.add(String.fromCharCode(i));
    lowerCaseCharCodes.add(String.fromCharCode(i + 32));
  }
}

final lowerCaseLatterKeyboard = [
  [
    const BasicKeyboardButtonConfig(
      label: 'q',
      value: r'\text{q}',
...
getLatter() {
  getChat();
  // var group = [];
  // for (int i = 0; i < lowerCaseCharCodes.length; i++) {
  //   var latter = lowerCaseCharCodes[i];
  //
  //   group.add(BasicKeyboardButtonConfig(
  //     label: latter,
  //     value: r'\text{${latter}}',
  //     keyboardCharacters: [latter],
  //   ));
  //   if (i % 10 == 0) {
  //     group = <KeyboardButtonConfig>[];
  //     lowerCaseLatterKeyboard.add(group);
  //   }
  // }
  //
  // for (int i = 0; i < charCodes.length; i++) {
  //   var latter = charCodes[i];
  //   if (i % 10 == 0) {
  //     group = <KeyboardButtonConfig>[];
  //     latterKeyboard.add(group);
  //   }
  //   group.add(BasicKeyboardButtonConfig(
  //     label: latter,
  //     value: r'\text{${latter}}',
